...
output: pdf_document
---
Estimating the Number of Protestors in the San Francisco Anti-War Protests
========================================================
...
DATA= read.csv(file="https://raw.githubusercontent.com/dvcv/Strat/master/Data/DATA.csv")
#Nh holds the size of each stratum
Nh=colSums(!is.na(DATA))
#naming the stratums
names(Nh)=c("Stratum 1","Stratum 2","Stratum 3","Stratum 4","Stratum 5")
Nh
```
...
```{r echo=FALSE}
#observationUnitPerStratum holds estimated number of observation units per stratum
observationUnitPerStratum=c(stratum.1=6.875*Nh[[1]],stratum.2=38.83*Nh[[2]],stratum.3=167*(Nh[[3]]),stratum.4=244.857*(Nh[[4]]),stratum.5=426*(Nh[[5]]))

#total.pop holds the estimated total population
total.pop=sum(observationUnitPerStratum)

#pl is concatenating observationUnitPerStratum and total.pop
pl=c(observationUnitPerStratum,total.pop)
#naming the 6 index of pl (or total.pop)
names(pl)=c("Stratum 1","Stratum 2","Stratum 3","Stratum 4","Stratum 5", "Total")
#barplot of estimates
barplot(pl,ylab="Estimated Protesters", names.arg = c("Stratum 1","Stratum 2","Stratum 3","Stratum 4","Stratum 5", "Total"), axisnames=TRUE, col = rainbow(6))
